#!/usr/bin/env python
"""
Script لإنشاء مستخدم admin في tenant محدد
"""
import os
import django
...
try:
    ...
    with tenant_context(tenant):
        ...
        print(f'   http://farm1.localhost:8000/admin/')
        
except Client.DoesNotExist:
    print(f'❌ Tenant "{SCHEMA_NAME}" غير موجود!')
    print('   قم بإنشاء tenant أولاً باستخدام:')
    print('   python manage.py create_tenant --schema_name farm1 ...')
